LSRCS		= libft/ft_strlen.c libft/ft_strlcpy.c libft/ft_strlcat.c \
		libft/ft_strchr.c libft/ft_strrchr.c libft/ft_strnstr.c libft/ft_strncmp.c \
		libft/ft_memset.c libft/ft_bzero.c libft/ft_memcpy.c libft/ft_memmove.c \
		...
		libft/ft_calloc.c libft/ft_strdup.c \
